...
class TestSquare_instantiation(unittest.TestCase):
    ...
    def test_is_base(self):
        self.assertIsInstance(Square(16), Base)

    def test_is_rectangle(self):
        self.assertIsInstance(Square(16), Square)
    ...
    def test_4_args(self):
        self.assertEqual(7, Square(16, 2, 2, 7).id)
...
class TestSquare_stdout(unittest.TestCase):
    ...
    def test_str_method_size_x_y_id(self):
        s = Square(2, 99, 4, 19)
        self.assertEqual("[Square] (19) 99/4 - 2", str(s))
...
class TestSquare_update_args(unittest.TestCase):
    ...
    def test_update_args_1(self):
        s = Square(10, 10, 10, 10)
        s.update(68)
        self.assertEqual("[Square] (68) 10/10 - 10", str(s))

    def test_update_args_2(self):
        s = Square(10, 10, 10, 10)
        s.update(68, 2)
        self.assertEqual("[Square] (68) 10/10 - 2", str(s))

    def test_update_args_3(self):
        s = Square(10, 10, 10, 10)
        s.update(68, 2, 3)
        self.assertEqual("[Square] (68) 3/10 - 2", str(s))
    ...
    def test_update_args_twice(self):
        ...
        s.update(68, 2, 3, 4)
        s.update(4, 3, 2, 68)
        self.assertEqual("[Square] (4) 2/68 - 3", str(s))
    ...
    def test_update_args_size_before_x(self):
        s = Square(10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            s.update(68, "invalid", "invalid")

    def test_update_args_size_before_y(self):
        s = Square(10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            s.update(68, "invalid", 2, "invalid")

    def test_update_args_x_before_y(self):
        s = Square(10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "x must be an integer"):
            s.update(68, 1, "invalid", "invalid")
...
class TestSquare_update_kwargs(unittest.TestCase):
    ...
    def test_update_kwargs_4(self):
        s = Square(10, 10, 10, 10)
        s.update(id=80, x=1, y=3, size=4)
        self.assertEqual("[Square] (80) 1/3 - 4", str(s))

    def test_update_kwargs_width_setter(self):
        s = Square(10, 10, 10, 10)
        s.update(id=80, size=8)
        self.assertEqual(8, s.width)

    def test_update_kwargs_height_setter(self):
        s = Square(10, 10, 10, 10)
        s.update(id=80, size=9)

...
class TestBase_instantiation(unittest.TestCase):
    ...
    def test_unique_id(self):
        self.assertEqual(19, Base(19).id)
    ...
    def test_str_id(self):
        self.assertEqual("Grady", Base("Grady").id)
...
class TestBase_save_to_file(unittest.TestCase):
    ...
    def test_save_to_file_one_rectangle(self):
        r = Rectangle(10, 9, 2, 8, 5)
        Rectangle.save_to_file([r])
        with open("Rectangle.json", "r") as f:
            self.assertTrue(len(f.read()) == 53)

    def test_save_to_file_two_rectangles(self):
        r1 = Rectangle(10, 9, 2, 8, 5)
...
class TestBase_from_json_string(unittest.TestCase):
    ...
    def test_from_json_string_type(self):
        list_input = [{"id": 89, "width": 14, "height": 4}]
        json_list_input = Rectangle.to_json_string(list_input)
        list_output = Rectangle.from_json_string(json_list_input)
        self.assertEqual(list, type(list_output))

    def test_from_json_string_one_rectangle(self):
        list_input = [{"id": 89, "width": 14, "height": 4, "x": 7}]
        json_list_input = Rectangle.to_json_string(list_input)
        list_output = Rectangle.from_json_string(json_list_input)
    ...
    def test_from_json_string_two_rectangles(self):
        list_input = [
            {"id": 89, "width": 14, "height": 4, "x": 7, "y": 8},
...
class TestBase_create(unittest.TestCase):
    ...
    def test_create_rectangle_original(self):
        r1 = Rectangle(3, 5, 1, 2, 9)
        r1_dictionary = r1.to_dictionary()
        r2 = Rectangle.create(**r1_dictionary)
        self.assertEqual("[Rectangle] (9) 1/2 - 3/5", str(r1))

    def test_create_rectangle_new(self):
        r1 = Rectangle(3, 5, 1, 2, 9)
        r1_dictionary = r1.to_dictionary()
        r2 = Rectangle.create(**r1_dictionary)
        self.assertEqual("[Rectangle] (9) 1/2 - 3/5", str(r2))
    ...
    def test_create_square_original(self):
        ...
        self.assertEqual("[Square] (9) 5/1 - 3", str(s1))
...
class TestBase_save_to_file_csv(unittest.TestCase):
    ...
    def test_save_to_file_csv_one_rectangle(self):
        ...
        with open("Rectangle.csv", "r") as f:
            self.assertTrue("5,10,9,2,8", f.read())
    ...
    def test_save_to_file_csv_two_rectangles(self):
        ...
        with open("Rectangle.csv", "r") as f:
            self.assertTrue("5,10,9,2,8\n2,4,1,2,3", f.read())

    def test_save_to_file_csv_one_square(self):
        s = Square(12, 7, 2, 8)
        Square.save_to_file_csv([s])
        with open("Square.csv", "r") as f:
            self.assertTrue("8,12,7,2", f.read())

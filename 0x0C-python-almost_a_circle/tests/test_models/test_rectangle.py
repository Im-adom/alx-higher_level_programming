...
class TestRectangle_instantiation(unittest.TestCase):
    ...
    def test_5_args(self):
        self.assertEqual(7, Rectangle(10, 5, 0, 0, 7).id)
...
class TestRectangle_update_args(unittest.TestCase):
    ...
    def test_update_args_1(self):
        r = Rectangle(10, 10, 10, 10, 10)
        r.update(68)
        self.assertEqual("[Rectangle] (68) 10/10 - 10/10", str(r))

    def test_update_args_2(self):
        r = Rectangle(10, 10, 10, 10, 10)
        r.update(68, 2)
        self.assertEqual("[Rectangle] (68) 10/10 - 2/10", str(r))

    def test_update_args_3(self):
        r = Rectangle(10, 10, 10, 10, 10)
        r.update(68, 2, 3)
        self.assertEqual("[Rectangle] (68) 10/10 - 2/3", str(r))

    def test_update_args_4(self):
        r = Rectangle(10, 10, 10, 10, 10)
        r.update(68, 2, 3, 4)
        self.assertEqual("[Rectangle] (68) 4/10 - 2/3", str(r))

    def test_update_args_5(self):
        r = Rectangle(10, 10, 10, 10, 10)
        r.update(68, 2, 3, 4, 5)
        self.assertEqual("[Rectangle] (68) 4/5 - 2/3", str(r))

    def test_update_args_more_than_5(self):
        r = Rectangle(10, 10, 10, 10, 10)
        r.update(68, 2, 3, 4, 5, 6)
        self.assertEqual("[Rectangle] (68) 4/5 - 2/3", str(r))
    ...
    def test_update_args_width_before_height(self):
        r = Rectangle(10, 10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            r.update(68, "invalid", "invalid")

    def test_update_args_width_before_x(self):
        r = Rectangle(10, 10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            r.update(68, "invalid", 1, "invalid")

    def test_update_args_width_before_y(self):
        r = Rectangle(10, 10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            r.update(68, "invalid", 1, 2, "invalid")
    ...
    def test_update_args_height_before_y(self):
        r = Rectangle(10, 10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "height must be an integer"):
            r.update(68, 1, "invalid", 1, "invalid")

    def test_update_args_x_before_y(self):
        r = Rectangle(10, 10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "x must be an integer"):
            r.update(68, 1, 2, "invalid", "invalid")
...
class TestRectangle_update_kwargs(unittest.TestCase):
    ...
    def test_update_kwargs_4(self):
        r = Rectangle(10, 10, 10, 10, 10)
        r.update(id=68, x=1, height=2, y=3, width=4)
        self.assertEqual("[Rectangle] (68) 1/3 - 4/2", str(r))

    def test_update_kwargs_5(self):
        r = Rectangle(10, 10, 10, 10, 10)
        r.update(y=5, x=4, id=99, width=1, height=2)
        self.assertEqual("[Rectangle] (99) 4/5 - 1/2", str(r))
    ...
    def test_update_kwargs_twice(self):
        r = Rectangle(10, 10, 10, 10, 10)
        r.update(id=68, x=1, height=2)
        r.update(y=3, height=15, width=2)
        self.assertEqual("[Rectangle] (68) 1/3 - 2/15", str(r))
    ...
    def test_update_kwargs_some_wrong_keys(self):
        r = Rectangle(10, 10, 10, 10, 10)
        r.update(height=5, id=68, a=1, b=54, x=19, y=7)
        self.assertEqual("[Rectangle] (68) 19/7 - 10/5", str(r))
...
class TestRectangle_to_dictionary(unittest.TestCase):
    ...
    def test_to_dictionary_output(self):
        r = Rectangle(10, 4, 1, 9, 5)
        correct = {'x': 1, 'y': 9, 'id': 5, 'height': 4, 'width': 10}
        self.assertDictEqual(correct, r.to_dictionary())

    def test_to_dictionary_no_object_changes(self):
        r1 = Rectangle(10, 4, 1, 9, 5)
